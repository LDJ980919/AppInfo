                            ...
                            <ul class="nav side-menu">
                                <li><a><i class="fa fa-home"></i> APP账户管理 <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu" style="display: none">
                                        <li><a href="javascript:;" id="select">开发者用户查询</a>
                                        </li>
                                        <li><a href="javascript:;" id="update">开发者用户修改</a>
                                        </li>
                                        <li><a href="javascript:;" id="delete">开发者用户删除</a>
                                        </li>
                                        <li><a href="javascript:;" id="add">开发者用户增加</a>
                                        </li>
                                    </ul>
                                </li>
