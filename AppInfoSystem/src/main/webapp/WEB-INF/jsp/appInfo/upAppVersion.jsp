	...
	<div class="x_panel">
                                    ...
                                    <form id="demo-form2" class="form-horizontal form-label-left" action="javascript:;" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input placeholder="请输入版本号" type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12" name="versionNo" value="${app.versionNo }">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input placeholder="请输入版本大小,单位为Mb" type="text" id="last-name" name="versionSize" required="required" class="form-control col-md-7 col-xs-12" value="${app.versionSize }">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input placeholder="请输入本版本的相关信息,本信息做为该版本的详细信息进行版本介绍" id="middle-name" class="form-control col-md-7 col-xs-12" type="text" name="versionInfo" value="${app.versionInfo }">
                                            </div>
                                        </div>
                                        <div class="form-group">
          ...
          <script type="text/javascript">
          	$("form").submit(function(){
          		$.ajax({
          			url:"<%=request.getContextPath() %>/appVersion/addAppVersionSave",
          			data:$("form").serialize(),
          			type:"post",
          			dataType:"text",
          			success:function(data){
          				...
          				if(data == "1"){
          					alert("修改成功!");
          					$("body").load("<%=request.getContextPath() %>/sys/devuser/index");
          				}else{
          					alert("修改失败");
          				}
          			}
